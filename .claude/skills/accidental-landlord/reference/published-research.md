# Example: Accidental Landlords Research

**Use this example for:** Institutional dynamics, market-wide trends, competitive positioning, multi-market comparison, data table integration, investor strategy narrative.

---

# When Sellers Can't Sell: Accidental Landlords Surge in Markets Where Institutional Investors Are Most Exposed
...
Whatever's next, Parcl Labs remains the only real-time source of accidental landlord data. For real estate players navigating shifting markets, understanding the interplay between failed home sales, rental conversions, and institutional positioning is alpha for identifying emerging risks and strategic opportunities.

## Methodology

Parcl Labs generated all data, analysis, and research cited in this article. Visit our data platform directly to explore more about Parcl Labs and our capabilities.

**Accidental Landlord Methodology**

Our analysis uses a rolling window approach to identify properties that transition from for-sale to for-rent listings. For each analysis date, we examine property events within a 110-day window:

- **50 days prior**: Listing lookback period
- **60 days forward**: Rental lookahead period

Properties qualify as "switched" when they meet specific criteria. They must show legitimate for-sale activity (new listings, price changes, or relistings) during the lookback window, followed by rental activity (rental listings, rent adjustments, or rental relistings) during the lookahead period. The same entity must own the property throughout this period.

To ensure data quality, we apply two key exclusions. First, we remove properties with sales transactions anywhere within the 110-day window, as these represent successful sales rather than strategic pivots. Second, we exclude properties with multiple ownership changes, as these likely indicate distressed sales or institutional activity rather than deliberate rental conversions.

This window-based approach captures the dynamic nature of property marketing decisions while maintaining analytical rigor. By focusing on same-owner transitions, we isolate intentional shifts from sale-to-rental strategies that reflect true market adaptation.
